...
class TasksTests(unittest.TestCase):
    ...
    def test_users_cannot_delete_tasks_that_are_not_created_by_them(self):
        self.create_user("mattgrogan", "matt.grogan@gmail.com", 'python')
        self.login('mattgrogan', 'python')
        self.app.get('/tasks', follow_redirects=True)
        self.create_task()
        self.logout()
        self.create_user('lisabodet', 'lisabodet@gmail.com', 'lisabodet')
        self.login('lisabodet', 'lisabodet')
